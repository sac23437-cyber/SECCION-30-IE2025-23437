...
.org 0x0004                     ; Vector de interrupción por cambio de pin (PCINT1)
    JMP PCINT1_ISR
...
SETUP:
	...
	; Configuración de las interrupciones por cambio de pin (PCINT1)
    LDI R16, (1 << PCINT12) | (1 << PCINT13) ; Habilitar PCINT12 (PC4) y PCINT13 (PC5)
    STS PCMSK1, R16
    LDI R16, (1 << PCIE1)       ; Habilitar interrupciones por cambio de pin en el grupo PCINT1
    STS PCICR, R16
...
PCINT1_ISR:
    ...
    ; Verificar si PC4 (incremento) fue presionado
    SBIS PINC, PC4
    CALL INCREMENTAR_VALOR

    ; Verificar si PC5 (decremento) fue presionado
    SBIS PINC, PC5
    CALL DECREMENTAR_VALOR
...
INCREMENTAR_VALOR:
    ; Lógica para incrementar el valor según el modo de visualización
    LDS R16, MODO_VISUALIZACION
    CPI R16, 2
    JMP INCREMENTAR_HORA_CONFIG
    CPI R16, 3
    JMP INCREMENTAR_FECHA_CONFIG
    CPI R16, 4
    JMP INCREMENTAR_ALARMA_CONFIG
    RET

DECREMENTAR_VALOR:
    ; Lógica para decrementar el valor según el modo de visualización
    LDS R16, MODO_VISUALIZACION
    CPI R16, 2
    JMP DECREMENTAR_HORA_CONFIG
    CPI R16, 3
    JMP DECREMENTAR_FECHA_CONFIG
    CPI R16, 4
    JMP DECREMENTAR_ALARMA_CONFIG
    RET
